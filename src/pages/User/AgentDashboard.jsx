...
import AgentReceivedEnquiries from '../agents/AgentReceivedEnquiries';
import AgentMyProperties from '../agents/AgentMyProperties';
import AgentAddProperty from '../agents/AgentAddProperty';
...
const AgentDashboard = () => {
    ...
    const handleTabChange = (tab) => {
        setActiveTab(tab);
        navigate(`/agentdashboard${tab === 'overview' ? '' : `/${tab}`}`);
    };
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex-1 p-8 flex flex-col overflow-y-auto">
                <div className="bg-white shadow-md rounded-lg p-6">
                   ...
                   {activeTab === 'addProperty' && <AgentAddProperty />} 
                    {activeTab === 'myProperties' && <AgentMyProperties />}
                    {activeTab === 'receivedEnquiries' && <AgentReceivedEnquiries />}
                </div>
            </div>
